...
const Gallery = () => {
    return (
        <div className='my-8'>
            <h1 className='text-center font-extrabold text-4xl p-2 text-gray-500 border border-slate-900 border-spacing-2 bg-pink-200 rounded-2xl'>Gallery Section !!!</h1>
